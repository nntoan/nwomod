...
country = {
  ...
  SUPPRESSION_RADICALISATION_HIT = 15, -- % base added to a movements radicalness
  INVESTMENT_SCORE_FACTOR = 1.0, -- how much foreign investment money counts towards your industry score
...
diplomacy = {
  ...
  PEACE_COST_TRANSFER_PROVINCES = 50,
  ...
  NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.10, -- Bonus to neighbouring countries when influencing
